...
{
	{
		...
		CommandBuffer_IssuePluginCustomTextureUpdateInternal_m2768217494(__this, (intptr_t)L_0, L_1, L_2, /*hidden argument*/NULL);
		return;
	}
}
#ifdef __clang__
